...
export default function DarkMode(props: DarkModeProps) {
  ...
  return ( 
    <div class="flex gap-2 w-full">
      <button class="h-12 w-12 rounded-lg p-2 block dark:hidden" onClick={setDarkModeOn}>
        <svg class="fill-grey-700" fill="currentColor" viewBox="0 0 20 20">
      ...
      <button class="h-12 w-12 rounded-lg p-2 hidden dark:block" onClick={setDarkModeOff}>
